...
public class ItemHandlerTest {
    ...
    public void getAllItems() {
        webTestClient.get().uri(ITEMS_CONSTANTS_FUNCTIONAL_URL_V1)
                .exchange()
                .expectStatus().isOk()
    ...
    public void getAllItems_approach3() {
        Flux<Item> itemList = webTestClient.get().uri(ITEMS_CONSTANTS_FUNCTIONAL_URL_V1)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType(MediaType.APPLICATION_JSON_UTF8)
    ...
    public void getOneItemTest() {
        webTestClient.get().uri(ItemsConstants.ITEMS_CONSTANTS_FUNCTIONAL_URL_V1.concat("/{id}"), "ABC")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void getOneItemTest_NotFound() {
        webTestClient.get().uri(ItemsConstants.ITEMS_CONSTANTS_FUNCTIONAL_URL_V1.concat("/{id}"), "DEF")
                .exchange()
    ...
    public void createItem() {
        ...
        webTestClient.post().uri(ITEMS_CONSTANTS_FUNCTIONAL_URL_V1)
    ...
    public void deleteItem() {
        webTestClient.delete().uri(ITEMS_CONSTANTS_FUNCTIONAL_URL_V1.concat("/{id}"), "ABC")
    ...
    public void updateItem(){
        ...
        webTestClient.put().uri(ITEMS_CONSTANTS_FUNCTIONAL_URL_V1.concat("/{id}"), "ABC")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .accept(MediaType.APPLICATION_JSON_UTF8)
                .body(Mono.just(item),Item.class)
                .exchange()
